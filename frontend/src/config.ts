...
export const FACTORY_ADDRESS_V2: `0x${string}`[] = ["0x2e67fab851Abad4B6dAd40B0eb9C82E1020A9469", "0xce2b3fdf0e230dd9da644ec348ea64e5b59a20b6"]; // Ed4nsFactoryV2 (V2) - Update after deployment
