...
const STEPS = [
  ...
  },
  {
    ...
    desc: `Each surviving token holder is entitled to an equal share of the total prize pool. Connect your wallet on the Arena page — if you hold a winner token, a Claim Prize button appears automatically. Prize is paid in the chain's native token (ETH on Base or Robinhood).`,
    callout:
