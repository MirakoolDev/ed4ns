...
Γùç injected env (0) from .env.local,.env // tip: Γîÿ multiple files { path: ['.env.local', '.env'] }
// Sources flattened with hardhat v2.28.6 https://hardhat.org

// SPDX-License-Identifier: AGPL-3.0-only AND Apache-2.0 AND MIT
...
interface IEntropy {
    ...
    function getFee(address provider, uint256 gasLimit) external view returns (uint256 fee);
}


// File lib/seadrop/lib/ERC721A/contracts/IERC721A.sol
...
// File lib/seadrop/lib/ERC721A/contracts/ERC721A.sol
...
// File lib/seadrop/lib/openzeppelin-contracts/contracts/utils/introspection/IERC165.sol
...
// File lib/seadrop/lib/solmate/src/utils/ReentrancyGuard.sol
...
/// @author Modified from OpenZeppelin (https://github.com/OpenZeppelin/../../../../../../lib/seadrop/lib/openzeppelin-contracts/contracts/blob/master/contracts/security/ReentrancyGuard.sol)
...
// File lib/seadrop/lib/openzeppelin-contracts/contracts/interfaces/IERC2981.sol
...
// File lib/seadrop/lib/utility-contracts/src/ConstructorInitializable.sol
...
// File lib/seadrop/lib/utility-contracts/src/TwoStepOwnable.sol
...
// File lib/seadrop/src/interfaces/ICreatorToken.sol
...
// File lib/seadrop/src/interfaces/ISeaDropTokenContractMetadata.sol
...
// File lib/seadrop/src/interfaces/ITransferValidator.sol
...
// File lib/seadrop/src/lib/ERC721AConduitPreapproved.sol
...
// File lib/seadrop/src/lib/ERC721TransferValidator.sol
...
// File lib/seadrop/src/ERC721ContractMetadata.sol
...
// File lib/seadrop/src/lib/SeaDropStructs.sol
...
// File lib/seadrop/src/interfaces/INonFungibleSeaDropToken.sol
...
// File lib/seadrop/src/lib/SeaDropErrorsAndEvents.sol
...
// File lib/seadrop/src/interfaces/ISeaDrop.sol
...
// File lib/seadrop/src/lib/ERC721SeaDropStructsErrorsAndEvents.sol
...
// File lib/seadrop/src/ERC721SeaDrop.sol
...
// File contracts/ed4nsSeaDrop.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.24;

/// @author ed4ns
/// @title  ed4nsSeaDrop ΓÇö Standalone Open Edition NFT & Commit-Reveal Survival Game
///
...
contract ed4nsSeaDrop is ERC721SeaDrop, IEntropyConsumer {
    ...
    // ΓöÇΓöÇΓöÇ Constructor (Standalone deployment) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    constructor(
        GameConfig memory config,
        address[] memory allowedSeaDrop,
        address _dice,
        address _diceProvider
    ...
    // ΓöÇΓöÇΓöÇ Game Initialization ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    // ΓöÇΓöÇΓöÇ SeaDrop Mint Override ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    /**
    ...
    function triggerCut() external payable {
        ...
        uint64 seq = dice.requestV2{value: msg.value}(diceProvider, userRandom, 200000);
    ...
    // ΓöÇΓöÇΓöÇ External View Helpers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
